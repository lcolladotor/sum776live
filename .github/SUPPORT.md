# Getting help with `sum776live`

Thank you for using `sum776live`!
...
* Bioconductor software related questions, such as bug reports and feature
  requests, should be addressed in the appropriate `Bioconductor/sum776live`
...
* Bioconductor software usage questions should be addressed in the
  ...
  to use the
  [appropriate package tag](https://support.bioconductor.org/tag/sum776live),
...
[search issues and pull requests](https://github.com/lcolladotor/sum776live/issues)
